...
export const metadata = {
  title: 'Face Verification System Internals | jchowlabs',
};
			...
			<div class="article-container">
				...
				<a href="/lab/facial-liveness-verification" style="text-decoration: none; display: block;">
                    <div class="try-yourself-cta" style="background: #f0f7ff; border: 1px solid #2563eb; padding: 24px 36px; margin: 35px 0; border-radius: 12px; cursor: pointer; transition: all 0.2s; box-shadow: 0 2px 8px rgba(37, 99, 235, 0.1); display: flex; align-items: center; gap: 16px;">
                        <p style="color: #1e40af; margin: 0; line-height: 1.6;"><span style="color: #2563eb; font-weight: 600;">Try yourself:</span> Try the interactive liveness detection demo in the <span style="font-weight: 600;">Facial Liveness Verification</span> lab.</p>
                    </div>
                </a>

				<div class="article-header">
					<h1>Face Verification System Internals</h1>
				</div>

				<div class="article-body">
					<p>In this article, we’re going to look under the hood of facial verification system. The goal is to develop stronger intuition for how modern facial recognition systems work from the moment you capture a face to the moment a system decides whether to grant access. We’ll walk through the core pieces step by step so you can see how they fit together as a coherent system rather than a black box.</p>
