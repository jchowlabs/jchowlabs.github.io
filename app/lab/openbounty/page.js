...
export const metadata = {
  title: 'Building a Pricing Engine from Scratch | jchowlabs',
};
...
export default function ArticlePage() {
                ...
                <a href="https://www.openbounty.com" target="_blank" style="text-decoration: none; display: block;">
                    <div class="try-yourself-cta" style="background: #f0f7ff; border: 1px solid #2563eb; padding: 24px 36px; margin: 35px 0; border-radius: 12px; cursor: pointer; transition: all 0.2s; box-shadow: 0 2px 8px rgba(37, 99, 235, 0.1); display: flex; align-items: center; gap: 16px;">
                        ...
                        <p style="color: #1e40af; margin: 0; line-height: 1.6;">
                            <span class="try-yourself-copy">Get an estimate at </span>
                            <span class="try-yourself-url" style="font-weight: 600;">www.openbounty.com</span>
  ...
  return (
    <div className="page-wrapper content-page article-page article-openbounty">
      <Header />
